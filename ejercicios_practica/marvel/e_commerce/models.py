...
class WishList (models.Model):
    id = models.BigAutoField (db_column='ID', primary_key=True)
    user = models.ForeignKey (User, verbose_name='user', blank=True, on_delete=models.CASCADE , default='new user')
    ...
    wished_qty = models.PositiveBigIntegerField(verbose_name='wished_qty',default=0)
    bought_qty = models.PositiveBigIntegerField(verbose_name='bought_qty',default=0)
